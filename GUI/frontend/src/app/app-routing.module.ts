...
const routes: Routes = [
  // { path: '', component: UpgradeDashnoardComponent },
  // {
  //   path: '',
  ...
  // },
  { path: 'upgradeDashboard', component:UpgradeDashnoardComponent},
  { path: 'installnewNSO', component: InstallNSOComponent },
  { path: 'inventoryHosts', component: InventoryHostsComponent },
  { path: 'configurations', component: ConfigurationComponent },
  { path: 'migrationReports', component: MigrationReportsComponent },
  {
    path: '', redirectTo: 'upgradeDashboard', pathMatch: 'full'
  },
  {
    path: '**', redirectTo: 'upgradeDashboard' ,pathMatch: 'full'
  }
